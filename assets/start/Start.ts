...
const _preloadRes = [
    ...
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Prefabs/Levels/level_1', type: 'prefab' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/bgm_1.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/bgm_2.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/dianji.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/luosi.mp3', type: 'audio' },
    ...
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/yidong.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/zhuangche.mp3', type: 'audio' },
];
